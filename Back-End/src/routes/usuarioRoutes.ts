...
class UsuarioRoutes{
    ...
    private config(){
        ...
        //Insertar
        this.router.post("/",[ jwtCheck,validate ],insertValidationRules(),usuarioController.insertar);
        //Actualizar
        this.router.put("/",[ jwtCheck,validate ],updateValidationRules(),usuarioController.actualizar);
        //Eliminar
