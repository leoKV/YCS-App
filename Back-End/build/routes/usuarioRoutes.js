...
class UsuarioRoutes {
    ...
    config() {
        ...
        //Insertar
        this.router.post("/", (0, UsuarioValidatorRules_1.insertUserValidationRules)(), [jwtCheck_1.jwtCheck, validatorCheck_1.validate], usuarioController_1.usuarioController.insertar);
        //Actualizar
        this.router.put("/", [jwtCheck_1.jwtCheck, validatorCheck_1.validate], usuarioController_1.usuarioController.actualizar);
        //Eliminar
